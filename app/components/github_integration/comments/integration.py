...
def comment_to_embed(comment: Comment) -> dsc.Embed:
    title = (
...
async def reply_with_comments(message: dsc.Message) -> None:
...
async def comment_processor(msg: dsc.Message) -> tuple[list[dsc.Embed], int]:

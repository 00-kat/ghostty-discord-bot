...
class ExtensibleMessage(dsc.Message):
    """
...
async def get_files(attachments: list[dsc.Attachment]) -> tuple[list[dsc.File], int]:
    """
...
class MessageData(ExtensibleMessage):
    ...
    @classmethod
    async def scrape(cls, message: dsc.Message) -> Self:
